...
// generate access and rfresh tokens
...
//controller for handleing login
const login = asyncHandler(async (req, res) => {
  ...
  //function for password checking is in models
...
//controller for forgetting password request
...
//controller for reset forgot password
...
//completing the resetting of password from previous function
...
//controller for chaninging current password
const changeCurrentPassword = asyncHandler(async (req, res) => {
  ...
  if (!isValid) {
    throw new ApiError(409, "password was incoorect");
  }
